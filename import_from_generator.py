...
class Operation(unittest.TestCase):
    ...
    def test_111(self):
        driver = self.driver
        driver.get("https://www.google.com.tw/webhp?hl=zh-TW&sa=X&ved=0ahUKEwiP7OK406DdAhWEU7wKHSYdBpIQPAgD")
        ...
        driver.find_element_by_id("id-search-field").send_keys("list")
